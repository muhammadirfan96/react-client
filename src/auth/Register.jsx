...
import ActivationUser from './ActivationUser.jsx';
...
const Register = () => {
  ...
  const [activation, setActivation] = useState(false); // aktivasi

  return (
    <>
      {showModal&&(<div className="bg-slate-900 bg-opacity-50 fixed right-0 left-0 top-0 bottom-0 z-10">
        <div className="w-[95%] md:w-[80%] lg:w-[50%] rounded-md shadow-md shadow-teal-100 p-2 bg-white mx-auto mt-20 relative">
          <p className="text-center border-b border-teal-700 mb-2">Register</p>
          <button
            onClick={back}
      ...
      <ActivationUser activation={{ activation, setActivation }} />
    </>
  );
};
